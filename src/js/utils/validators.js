...
import { ALL_CHANNELS, DEFAULT_BRANDS } from '../../data/initialData.js';
 ...
 * @param {Object} record - Sales data record to validate
 * @returns {Object} { isValid: boolean, errors: array }
 */
export function validateSalesRecord(record) {
    const errors = [];
...
/**
 * Validate batch of sales records
 * @param {Array} records - Array of sales records
 * @returns {Object} { isValid: boolean, errors: array, validRecords: array }
 */
export function validateSalesData(records) {
    const errors = [];
    const validRecords = [];
 ...
 * Validate brand name
 */
export function isValidBrand(brand, customBrands = []) {
 ...
 */
export function validateCSVHeaders(headers, requiredHeaders = ['Date', 'Channel', 'Brand', 'Revenue']) {
    const errors = [];
 ...
 * Validate brand form
 */
export function validateBrandForm(formData) {
    const errors = {};
...
// Export all validators as default object too
export default {
    validateSalesRecord,
    validateSalesData,
    isValidDate,
