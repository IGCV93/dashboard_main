...
export function getDaysInPeriod(view, selectedPeriod, selectedYear, selectedMonth) {
...
export function getDaysElapsed(view, selectedPeriod, selectedYear, selectedMonth) {
...
export function getTwoBusinessDaysAgo() {
    const today = new Date();
    today.setHours(0, 0, 0, 0);
