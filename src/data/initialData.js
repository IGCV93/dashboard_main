 ...
 * Distributes total amount across channels with predefined weights
 */
 ...
 */
export function generateSampleData(startDate, endDate, brands = DEFAULT_BRANDS, channels = ALL_CHANNELS) {
    const data = [];
 ...
 */
export const CSV_TEMPLATE_HEADERS = ['Date', 'Channel', 'Brand', 'Revenue'];
